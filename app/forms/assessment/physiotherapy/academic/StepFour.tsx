...
// These match the keys we will use in the page.tsx state!
const CATEGORY_MAP = [
  ...
  { key: 'exerciseTherapy', title: 'v. Exercise Therapy / Gymnasium' },
  { key: 'electrotherapy', title: 'vi. Electrotherapy Demonstration Room' },
  { key: 'hydrotherapy', title: 'vii. Hydrotherapy Room' },
  { key: 'simulationLab', title: 'viii. Simulation Laboratory' },
  { key: 'diagnostic', title: 'ix. Diagnostic Equipment' },
  { key: 'infectionControl', title: 'x. Infection Control' },
  { key: 'paediatric', title: 'xi. Paediatric Physiotherapy Unit' },
  { key: 'neurology', title: 'xii. Neurology Physiotherapy Unit' },
  { key: 'orthopaedics', title: 'xiii. Orthopaedics and Musculoskeletal Physiotherapy Unit' },
  { key: 'pelvicHealth', title: 'xiv. Pelvic and Women\'s Health Physiotherapy Unit' },
  { key: 'cardioPulmonary', title: 'xv. Cardio-Pulmonary Physiotherapy Unit' },
  { key: 'geriatric', title: 'xvi. Geriatric Physiotherapy Unit' },
  { key: 'communityBased', title: 'xvii. Community-Based Physiotherapy Unit' },
  { key: 'palliativeCare', title: 'xviii. Palliative Care Physiotherapy Unit' },
  { key: 'mentalHealth', title: 'xix. Mental Health Physiotherapy Unit' },
  { key: 'ergonomics', title: 'xx. Ergonomics and Occupational Health Physiotherapy Unit' },
  { key: 'sports', title: 'xxi. Sports and Recreational Physiotherapy Unit' },
  { key: 'safetyMeasures', title: 'xxii. Safety Measures' }
];

export default function StepFour({ data, updateCategory, onPrev, onSubmit, isSubmitting }: StepFourProps) {
                  ...
                  <tbody className="divide-y divide-gray-100">
                    {equipmentList.map((eq: any, index: number) => (
                      <tr key={index} className="hover:bg-[#F8FCF5] transition-colors group">
                        ...
                        {eq.isHeader ? (
                          <td colSpan={2} className="py-1 px-3 text-[10px] text-gray-400 italic bg-gray-50/50 text-right">Please select options below</td>
                        ) : (
                          <>
